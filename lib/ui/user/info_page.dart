...
class InformationPageState extends State<InformationPage> {
  ...
  Future<Traveler> loadData() async {
    if (account != null && isEnable) return account;
    ...
    return travelerController.findByEmail(email).then((data) {
      if (data != null) {
        ...
        _phoneNumber.text = account.phoneNumber;
                ...
                if (snapshot.hasData) {
                  return Column(
                    ...
                    children: <Widget>[
                      ...
                      buildBody(context, snapshot),
                      buildFooter(context, snapshot),
                    ],
                  );
                } else {
                  return Center(
  ...
  Widget buildHeader(BuildContext context, AsyncSnapshot snapshot) {
                    ...
                    children: <Widget>[
                      InkWell(
                        child: NLRadioItemButton(
                          RadioModel(
                              account.gender == Gender.MALE ? true : false,
                              'men'),
                        ),
                      ...
                      InkWell(
                        child: NLRadioItemButton(
                          RadioModel(
                              account.gender == Gender.FEMALE ? true : false,
                              'women'),
                        ),
                        splashColor: Color(0xff008fe5),
                      ),
  ...
  Widget buildFooter(BuildContext context, AsyncSnapshot snapshot) {
              ...
              children: <Widget>[
                Container(
                  ...
                  child: InkWell(
                    onTap: () {
                      dialogs.confirm3(
                          context, 'Change Your Password', _confirmWidget, 'NO',
                          () {
                        Navigator.of(context).pop();
                        changePass();
                      });
  ...
  Future<Traveler> updateUser() async {
    ...
    account.phoneNumber =
        _phoneNumber.text.isEmpty ? account.phoneNumber : _phoneNumber.text;
  ...
  void changePass() {
    ...
    controller
        .changePassword(account.email, _oldPassword.text, _password.text)
        .then((data) {
